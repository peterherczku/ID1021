...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{./graph_1/data} % Adjust width or height as needed
  \end{subfigure}
...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{./graph_1/data_2} % Adjust width or height as needed
  \end{subfigure}
  \caption{Graph of the minimum, maximum and average execution time on different sizes of arrays}
  \label{fig:graph_2}
\end{figure}
